...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
  ...
  public int printHeights(Position<E> p) throws IllegalArgumentException {
      Node<E> node = validate(p);
      ...
      if (node.getLeft() != null)
          leftHeight = printHeights(node.getLeft());
      if (node.getRight() != null)
          rightHeight = printHeights(node.getRight());
      ...
      System.out.println(node.getElement() + " height = " + h);
      return h;
  }
